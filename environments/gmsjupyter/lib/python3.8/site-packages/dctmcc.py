...
GAMSVERSION = _dctmcc.GAMSVERSION

GAMSMAJOR = _dctmcc.GAMSMAJOR

GAMSMINOR = _dctmcc.GAMSMINOR

GAMSGOLD = _dctmcc.GAMSGOLD
...
def gmsFixEquType(userInfo):
    ...
    return _dctmcc.gmsFixEquType(userInfo)

def gmsFixVarType(userInfo):
    r"""gmsFixVarType(userInfo) -> int"""
    return _dctmcc.gmsFixVarType(userInfo)
