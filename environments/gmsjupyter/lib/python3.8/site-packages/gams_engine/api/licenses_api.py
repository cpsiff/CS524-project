...
class LicensesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __delete_system_wide_gams_license(
            self,
            **kwargs
        ):
        ...
        self.delete_system_wide_gams_license = _Endpoint(
            settings={
                'response_type': (Message,),
                'auth': [
                    'BasicAuth'
            ...
            api_client=api_client,
            callable=__delete_system_wide_gams_license
        )

        def __get_engine_license(
            self,
            **kwargs
        ):
        ...
        self.get_engine_license = _Endpoint(
            settings={
        ...
        def __get_system_wide_gams_license(
            self,
            **kwargs
        ):
        ...
        self.get_system_wide_gams_license = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_system_wide_gams_license
        )

        def __update_engine_license(
            self,
            license,
            **kwargs
        ):
        ...
        self.update_engine_license = _Endpoint(
            settings={
                'response_type': (Message,),
                'auth': [
                    'BasicAuth'
            ...
            api_client=api_client,
            callable=__update_engine_license
        )
        ...
        def __update_system_wide_gams_license(
            self,
            license,
            **kwargs
        ):
        ...
        self.update_system_wide_gams_license = _Endpoint(
            settings={
                'response_type': (Message,),
                'auth': [
                    'BasicAuth'
            ...
            api_client=api_client,
            callable=__update_system_wide_gams_license
        )
