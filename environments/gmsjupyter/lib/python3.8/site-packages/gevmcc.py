...
GAMSVERSION = _gevmcc.GAMSVERSION

GAMSMAJOR = _gevmcc.GAMSMAJOR

GAMSMINOR = _gevmcc.GAMSMINOR

GAMSGOLD = _gevmcc.GAMSGOLD
...
def gmsFixEquType(userInfo):
    ...
    return _gevmcc.gmsFixEquType(userInfo)

def gmsFixVarType(userInfo):
    r"""gmsFixVarType(userInfo) -> int"""
    return _gevmcc.gmsFixVarType(userInfo)
