...
GAMSVERSION = _cfgmcc.GAMSVERSION

GAMSMAJOR = _cfgmcc.GAMSMAJOR

GAMSMINOR = _cfgmcc.GAMSMINOR

GAMSGOLD = _cfgmcc.GAMSGOLD
...
def gmsFixEquType(userInfo):
    ...
    return _cfgmcc.gmsFixEquType(userInfo)

def gmsFixVarType(userInfo):
    r"""gmsFixVarType(userInfo) -> int"""
    return _cfgmcc.gmsFixVarType(userInfo)
