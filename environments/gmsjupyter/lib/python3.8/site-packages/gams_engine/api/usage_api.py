...
class UsageApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_quota = _Endpoint(
            ...
            api_client=api_client,
            callable=__delete_quota
        )

        def __delete_user_instances(
            self,
            username,
            **kwargs
        ):
        ...
        self.delete_user_instances = _Endpoint(
            settings={
                'response_type': (Message,),
                'auth': [
                    'BasicAuth'
            ...
            api_client=api_client,
            callable=__delete_user_instances
        )
        ...
        self.get_instances = _Endpoint(
            settings={
                'response_type': ([ModelInstanceInfo],),
                'auth': [
                    'BasicAuth'
                ],
                'endpoint_path': '/usage/instances',
        ...
        def __get_quota(
            ...
            **kwargs
            ...
            Users inherit quotas from their (grand) inviters as well.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_usage(
            ...
            **kwargs
            ...
            Admins can query everyone's usage data. Inviters can query their subtree's usage data. Users can only query their own usage data.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.get_user_instances = _Endpoint(
            settings={
        ...
        def __update_quota(
            ...
            **kwargs
            ...
            If the user is inviter, everyone in the user's subtree is also effected. Admins cannot have quotas.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.update_user_instances = _Endpoint(
            settings={
                'response_type': (Message,),
                'auth': [
                    'BasicAuth'
            ...
            api_client=api_client,
            callable=__update_user_instances
        )
