...
from gams_engine.exceptions import ApiException, UnauthorizedException, ForbiddenException, NotFoundException, ServiceException, ApiValueError
...
class RESTClientObject(object):
    ...
    def request(self, method, url, query_params=None, headers=None,
        ...
        if 'Content-Type' not in headers and method in ['POST', 'PUT', 'PATCH', 'OPTIONS']:
