...
GAMSVERSION = _idxcc.GAMSVERSION

GAMSMAJOR = _idxcc.GAMSMAJOR

GAMSMINOR = _idxcc.GAMSMINOR

GAMSGOLD = _idxcc.GAMSGOLD
...
def gmsFixEquType(userInfo):
    ...
    return _idxcc.gmsFixEquType(userInfo)

def gmsFixVarType(userInfo):
    r"""gmsFixVarType(userInfo) -> int"""
    return _idxcc.gmsFixVarType(userInfo)
