...
class ModelAuthToken(object):
    ...
    def __init__(self, token=None, local_vars_configuration=None):  # noqa: E501
        """ModelAuthToken - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def token(self):
        """Gets the token of this ModelAuthToken.  # noqa: E501


        :return: The token of this ModelAuthToken.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this ModelAuthToken.


        :param token: The token of this ModelAuthToken.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModelAuthToken):
            return False
