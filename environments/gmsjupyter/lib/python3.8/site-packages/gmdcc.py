...
GAMSVERSION = _gmdcc.GAMSVERSION

GAMSMAJOR = _gmdcc.GAMSMAJOR

GAMSMINOR = _gmdcc.GAMSMINOR

GAMSGOLD = _gmdcc.GAMSGOLD
...
def gmsFixEquType(userInfo):
    ...
    return _gmdcc.gmsFixEquType(userInfo)

def gmsFixVarType(userInfo):
    r"""gmsFixVarType(userInfo) -> int"""
    return _gmdcc.gmsFixVarType(userInfo)
