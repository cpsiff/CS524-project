...
def gmoEvalFuncNLCluster(pgmo, si, x, cluster, ncluster, fnl):
    r"""gmoEvalFuncNLCluster(pgmo, si, x, cluster, ncluster, fnl) -> int"""
    return _gmomcc.gmoEvalFuncNLCluster(pgmo, si, x, cluster, ncluster, fnl)

def gmoEvalFuncNLCluster_MT(pgmo, si, x, cluster, ncluster, fnl, tidx):
    r"""gmoEvalFuncNLCluster_MT(pgmo, si, x, cluster, ncluster, fnl, tidx) -> int"""
    return _gmomcc.gmoEvalFuncNLCluster_MT(pgmo, si, x, cluster, ncluster, fnl, tidx)
...
GAMSVERSION = _gmomcc.GAMSVERSION

GAMSMAJOR = _gmomcc.GAMSMAJOR

GAMSMINOR = _gmomcc.GAMSMINOR

GAMSGOLD = _gmomcc.GAMSGOLD
...
def gmsFixEquType(userInfo):
    ...
    return _gmomcc.gmsFixEquType(userInfo)

def gmsFixVarType(userInfo):
    r"""gmsFixVarType(userInfo) -> int"""
    return _gmomcc.gmsFixVarType(userInfo)
